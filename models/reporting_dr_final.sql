select 
    ...
    CASE
        WHEN file_expiry_status = 'Not expired' and file_verification_status = 'Approved' THEN 'Valid'
    ...
    create_desc,
    row_number() OVER (
        partition by org_id, document_id 
        ORDER by CASE
            WHEN file_expiry_status = 'Not expired' and file_verification_status = 'Approved' THEN 0
            ...
            ELSE 6 end asc
        , expiry desc, create_timestamp desc)        AS expiry_create_desc,
