with onb_final as (
    ...
    from {{ ref('reporting_dr_onboarding_raw') }} onb
)
select
    onb_final.*,
    onb_final."Onboarding Completion Time" >= CURRENT_DATE - 30
        AND onb_final."Onboarding Completion Time" < CURRENT_DATE as "Completed Onboarding Last 30 Days",
    onb_final."Onboarding Completion Time" >= CURRENT_DATE - 7
        AND onb_final."Onboarding Completion Time" < CURRENT_DATE as "Completed Onboarding Last 7 Days",
    onb_final."Onboarding Completion Time" >= CURRENT_DATE - 1
        AND onb_final."Onboarding Completion Time" < CURRENT_DATE as "Completed Onboarding Yesterday"
from onb_final